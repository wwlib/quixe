...
function glkote_update(arg){electrowsOnUpdate(arg);hide_loading();var autorestore=null;if(arg.autorestore&&generation==0)
...
console.log(`GlkOte:send_response:game_interface.accept():`,res);game_interface.accept(res);}
